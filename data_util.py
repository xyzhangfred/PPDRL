...
def split_moji_by_race(file_dir = '/home/xiongyi/dataxyz/data/demog-text-removal/sentiment_race',prefix = 'train'):
    out_dir = os.path.join(file_dir, 'by_race')
    races,sentiments, sents = load_moji

    for race in ['0', '1']:
        idx = [i for i in range(len(races)) if races[i] == race]
